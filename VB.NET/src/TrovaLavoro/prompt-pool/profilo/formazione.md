...
Il tuo compito in questo turno è ricavare i titoli di studio e i corsi di FORMAZIONE descritti dall'utente: diplomi, qualifiche, corsi di formazione, percorsi di studio strutturati, patentini e abilitazioni professionali (es. patentino del muletto, HACCP).

Per ogni voce di formazione raccogli questi campi:
- "titolo": il titolo di studio, il corso o il patentino (es. Diploma alberghiero, corso di saldatura, patentino del muletto)
