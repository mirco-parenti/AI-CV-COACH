...
Public Class FinestraBackup
    ...
    Private Sub Disponi()
        ...
        btnChiudi.Location = New Point(LarghezzaFinestra - StileApp.MargineRiquadro - btnChiudi.Width, riga)

        ClientSize = New Size(LarghezzaFinestra, btnChiudi.Bottom + StileApp.MargineRiquadro)
