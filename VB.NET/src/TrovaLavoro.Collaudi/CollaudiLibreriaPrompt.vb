...
Namespace Ai
    ...
    Public Class CollaudiLibreriaPrompt
        ...
        Public Sub IlPoolIntegratoSiApre()
            ...
            Assert.AreEqual("1.01", libreria.Versione, "versione del pool")
            Assert.AreEqual("Pool 1.01 (integrato)", libreria.Etichetta, "etichetta accanto al logo")
        End Sub
        ...
        Public Sub UnPoolEsternoRottoRipiegaSullIntegrato()
            ...
            Try
                ...
                Assert.AreEqual("1.01", libreria.Versione, "con la versione dell'integrato")
